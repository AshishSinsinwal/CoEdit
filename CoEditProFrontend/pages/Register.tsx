...
const Register: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Ambient blobs */}
      <div className="absolute top-[-10%] right-[-5%] w-96 h-96 rounded-full bg-purple-500/20 blur-3xl pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-5%] w-96 h-96 rounded-full bg-indigo-500/20 blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 max-w-md w-full">
        ...
        ">
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-sm text-white/50">Join and start co-editing in real time</p>
          </div>
